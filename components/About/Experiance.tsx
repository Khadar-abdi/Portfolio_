...
const Experiance = () => {
    return (
        <div className='flex flex-col pt-5 flex-wrap'>
            ...
            <div className='flex lg:flex-row  md:flex-row  flex-col  lg:justify-between items-start  md:justify-between    pt-10    border-slate-100 border-b-[1px] pb-3  dark:border-slate-600 '>
                ...
                <div className='flex md:flex-col lg:flex-col  flex-row-reverse md:gap-3 lg:gap-3 gap-10 justify-between items-end  '>
                    <span className='p-x4 py-2 bg-green-200 dark:bg-[#336433] text-xs   font-pop rounded-full text-center w-2/3 items-end'> Part-Time</span>
                    <span className='flex flex-row gap-3 text-xs text-[#A7A7A7] font-pop'> <BsCalendarEvent /> Apr- 2024 - Present </span>
                </div>
            ...
            <div className='flex lg:flex-row  md:flex-row  flex-col  lg:justify-between  md:justify-between  items-start pt-10   border-slate-100 border-b-[1px] pb-3  dark:border-slate-600 '>
                ...
                <div className='flex md:flex-col lg:flex-col  flex-row-reverse md:gap-3 lg:gap-3 gap-10 justify-between items-end  '>
                    ...
                    <span className='flex flex-row gap-3 text-xs text-[#A7A7A7] font-pop'> <BsCalendarEvent /> sep- 2023 - Present </span>
                </div>
            ...
            <div className='flex lg:flex-row  md:flex-row  flex-col  lg:justify-between  md:justify-between  items-start pt-10   border-slate-100 border-b-[1px] pb-3  dark:border-slate-600 '>
                <div className='flex  lg:flex-col md:flex-col flex-row  gap-7'>
                    ...
                    <div className='flex lg:flex-row md:flex-row flex-col  gap-2 lg:gap-7 md:gap-6 pt-1'>
                        <span className='text-xs text-[#A7A7A7]  font-pop flex flex-row gap-2'><MdOutlineBusinessCenter /> Tibyan Collage Online</span>
                        <span className='flex flex-row gap-3 text-xs text-[#A7A7A7] font-pop'> <IoLocationOutline /> Hargeisa</span>
                    </div>
                </div>
                <div className='flex md:flex-col lg:flex-col  flex-row-reverse md:gap-3 lg:gap-3 gap-10 justify-between items-end  '>
                    <span className='p-x4 py-2 bg-green-200 dark:bg-[#336433] text-xs   font-pop rounded-full text-center w-2/3 items-end'> Full-Time</span>
                    <span className='flex flex-row gap-3 text-xs text-[#A7A7A7] font-pop'> <BsCalendarEvent /> sep- 2022 - Oct-2023 </span>
                </div>
            ...
            <div className='flex lg:flex-row  md:flex-row  flex-col  lg:justify-between  md:justify-between  items-start pt-10   border-slate-100 border-b-[1px] pb-3  dark:border-slate-600 '>
                <div className='flex  lg:flex-col md:flex-col flex-row  gap-7'>
                    ...
                    <div className='flex lg:flex-row md:flex-row flex-col  gap-2 lg:gap-7 md:gap-6 pt-1'>
                        <span className='text-xs text-[#A7A7A7]  font-pop flex flex-row gap-2'><MdOutlineBusinessCenter /> NEC</span>
                        <span className='flex flex-row gap-3 text-xs text-[#A7A7A7] font-pop'> <IoLocationOutline /> Hargeisa</span>
                    </div>
                </div>
                <div className='flex md:flex-col lg:flex-col  flex-row-reverse md:gap-3 lg:gap-3 gap-10 justify-between items-end  '>
                    <span className='p-x4 py-2 bg-green-200 dark:bg-[#336433] text-xs   font-pop rounded-full text-center w-2/3 items-end'> Contruct</span>
                    <span className='flex flex-row gap-3 text-xs text-[#A7A7A7] font-pop'> <BsCalendarEvent /> Nov- 2021 - Jun-2022 </span>
                </div>
