...
const Header = () => {
    ...
    return (
        ...
        <div className=' flex lg:justify-evenly justify-between items-center py-2  fixed top-0 left-0 w-screen dark:bg-transparent bg-transparent dark:backdrop-blur-3xl backdrop-blur-md  '>
            ...
            <div className=' flex flex-col justify-center font-extrabold  text-center bg-gradient-to-l from-pink-500 to-cyan-500 bg-clip-text text-transparent'>
                <div className='flex flex-row  pl-8 md:pl-3 '>
                    ...
                    <div className='flex flex-col text-center    justify-center mx-3 py-3  '>
